  ...
  <div class="mx-auto max-w-3xl">
    ...
    <section class="mt-8 rounded-2xl border border-default bg-surface p-8">
      ...
      <div class="flex items-center gap-5">
        <div class="flex h-20 w-20 items-center justify-center rounded-full bg-primary text-2xl font-bold text-on-primary">
          {{ iniciales }}
        </div>
        <div>
      ...
      <dl class="mt-8 space-y-5 border-t border-default pt-8">
        ...
        <div class="grid grid-cols-3 items-center gap-4">
          ...
          <dd class="col-span-2 font-medium text-ink">{{ ROLE_LABEL[auth.rol ?? 'docente'] }}</dd>
        </div>
        <div class="grid grid-cols-3 items-center gap-4">
